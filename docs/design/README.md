...
- [The design records and the specifications are a governed corpus, typed and indexed by a pinned Headwater](DR-0021-headwater-governed-design-records.md) — Both documentation shelves become a typed corpus checked in CI by a pinned Headwater binary, with the specifications split into functional and technical layers and both shelf indexes generated.
