...
- [Design records are a governed corpus, typed and indexed by a pinned Headwater](DR-0021-headwater-governed-design-records.md) — The design-record shelf becomes a typed corpus checked in CI by a pinned Headwater binary, which also generates the shelf index the repository used to maintain by hand.
